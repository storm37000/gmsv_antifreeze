...
ifeq ($(config),debug)
OBJDIR = obj/Debug
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m32 -Og -fPIC
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m32 -Og -fPIC
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib32 -m32 -shared -Wl,-soname=gmsv_antifreeze_linux.dll -s
